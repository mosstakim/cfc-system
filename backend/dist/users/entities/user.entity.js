...
__decorate([
    (0, typeorm_1.Column)({
        ...
        default: user_role_enum_1.UserRole.CANDIDATE,
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => establishment_entity_1.Establishment, (establishment) => establishment.admins, { nullable: true }),
